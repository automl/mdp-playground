#!/bin/bash
#MOAB -N mdpp
#MOAB -t 5-9 # specifies array job indices
...
export EXP_NAME='rainbow_space_invaders_image_transforms' # Ideally contains Area of research + algorithm + dataset # Could just pass this as job name?
