#!/bin/bash
#MOAB -N mdpp
#MOAB -t 0-161 # specifies array job indices
#MOAB -l nodes=1:ppn=2
#MOAB -l walltime=0:06:00:00
#MOAB -l pmem=8GB
...
export EXP_NAME='td3_reacher_tune_hps' # Ideally contains Area of research + algorithm + dataset # Could just pass this as job name?
