#!/bin/bash
#MOAB -N mdpp
#MOAB -t 0-799 # specifies array job indices
...
export EXP_NAME='dqn_p_noises_various_lrs' # Ideally contains Area of research + algorithm + dataset # Could just pass this as job name?
