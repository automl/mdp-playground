#!/bin/bash
#MOAB -N mdpp
#MOAB -t 0 # specifies array job indices
#MOAB -l nodes=1:ppn=2
#MOAB -l walltime=0:00:35:00
...
export EXP_NAME='rainbow_beam_rider_del' # Ideally contains Area of research + algorithm + dataset # Could just pass this as job name?
