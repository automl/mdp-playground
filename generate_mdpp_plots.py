# Example: py generate_mdpp_plots.py -i 13699485 -n dqn_del # -p
...
def generate_plots(exp_name, exp_id, show_plots=False):
    ...
    mdpp_analysis.plot_1d_dimensions(train_stats, save_fig, show_plots=show_plots)
...
if __name__ == "__main__":
    ...
    if args.exp_file is not None:
        ...
        for exp_id in yaml_dict:
            generate_plots(exp_id=exp_id, exp_name=yaml_dict[exp_id], show_plots=args.show_plots)
