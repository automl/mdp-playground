...
#SBATCH -a 0-319 # Sets SLURM_ARRAY_TASK_ID - array index values, e.g. 0-31:2; 0-11%4 (it means max 4 tasks at a time)

export EXP_NAME='td3_move_to_a_point_p_noise_target_radius' # Ideally contains Area of research + algorithm + dataset # Could just pass this as job name?
