...
#SBATCH -a 0-399 # Sets SLURM_ARRAY_TASK_ID - array index values, e.g. 0-31:2; 0-11%4 (it means max 4 tasks at a time)

export EXP_NAME='rainbow_seq' # Ideally contains Area of research + algorithm + dataset # Could just pass this as job name?
